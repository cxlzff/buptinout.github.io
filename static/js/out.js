        ...
        return (
            ...
            <div>
              <img src={user} alt="logo" style={{ display: "block" }} />
                        ...
                        <div className="info"><p className="yes">允许出校</p></div>
                        <div className="title"><p className="titleI">学工号</p></div>
                        <div className="info">2019140525</div>
                        <div className="title"><p className="titleI">出入校时间</p></div>
                        <div className="info">{this.state.time}</div>
                    </div>

                    <div className="bottom"  width="100%">
                        <img src="https://cdn.jsdelivr.net/gh/shumil573/for-pri@v0.1.0/bluffing-image/bottom1.jpg" alt="logo" style={{ display: "block" }} />{/*设置display:"block"可以去掉图像的白边*/}
                    </div>
                </div>
